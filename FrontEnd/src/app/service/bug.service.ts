...
public getProjectName(form: FormData): void
{
  ...
  public createBugFormDate(bug: Bug, type: Bug): FormData {
    ...
    formData.append('bugType', type.bugType);
  ...
  public updateBugFormDate(bug: Bug,currentBugId:string,type: Bug): FormData {
